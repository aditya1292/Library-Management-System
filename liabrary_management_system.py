...
con = pymysql.connect (host="localhost",user="root",password="mypassword",database="db")
...
background_image =Image.open(r"C:\Users\adity\Downloads\book.jpg") #here you need to gave a background_image for your project that is the image location
...
#adding the aapki apni library frame
headingFrame1 = Frame(root,bg="#FFBB00",bd=5)
headingFrame1.place(relx=0.2,rely=0.1,relwidth=0.6,relheight=0.16)
headingLabel = Label(headingFrame1, text="Welcome to \n Aapki Apni Library", bg='black', fg='white', font=('Courier',15))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)

#this is a function to create a bookregister which keeps the books data
def bookRegister():
...
#here is the code for adding the book/books the shelves
def addBook(): 
...
#to view the books here is the code
bookTable = "books" 
def View(): 
...
#Here is the code to delete the book
